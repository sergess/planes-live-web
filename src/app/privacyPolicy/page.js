  ...
  return (
    <ModalProvider>
      ...
      <main className={styles.main}>
        <p>Read the Privacy Policy <Link href="terms">here</Link>.</p>
        <h1 className={styles.lastUpdate}>Last Updated: November 11, 2022</h1>
        <div className={styles.text}>
          <p>These Terms of Service (the "Terms") govern your access to and use of the services provided by Clime
            Weather Services, LLC ("Clime Weather"), a subsidiary of Apalon LLC ("Apalon" and together with Clime
            Weather, "Clime", "we", "us" or "our"), including its mobile applications, websites, email notifications,
            and any and all related services (collectively the "Services"). These Terms also govern your access to any
            information, text, graphics, photos, audio, video or other materials made available through the Services
            (the "Content"). PLEASE READ THESE TERMS OF SERVICE CAREFULLY BEFORE ACCESSING OR USING ANY OF THE
            SERVICES.</p>
          <h4>CONTENTS</h4>
          <div className={styles.menu}>
            <a href="#a">A. AGREEMENT</a><br/>
            <a href="#b">B. AGE REQUIREMENT</a><br/>
            <a href="#c">C. GRANT OF LICENSE</a><br/>
            <a href="#d">D. DESCRIPTION OF OTHER RIGHTS AND LIMITATIONS</a><br />
            <a href="#d1" style={{paddingLeft: '10px'}}>1. Restricted Use</a><br/>
            <a href="#d2" style={{paddingLeft: '10px'}}>2. Apps Updates</a><br/>
            <a href="#d3" style={{paddingLeft: '10px'}}>3. Access</a><br/>
            <a href="#d4" style={{paddingLeft: '10px'}}>4. Purchases &amp; Cancellation Rights</a><br/>
            <a href="#da" style={{paddingLeft: '20px'}}>(A). Subscriptions.</a><br/>
            <a href="#db" style={{paddingLeft: '20px'}}>(B). Paid Applications</a><br/>
            <a href="#d5" style={{paddingLeft: '10px'}}>5. Automatic Renewal</a><br/>
            <a href="#e">E. FEATURES &amp; FUNCTIONALITY</a><br/>
            <a href="#f">F. CONTENT on the SERVICES:</a><br/>
            <a href="#f1" style={{paddingLeft: '10px'}}>1. User Content.</a><br/>
            <a href="#f2" style={{paddingLeft: '10px'}}>2. Content Screening and Disclosure</a><br/>
            <a href="#f3" style={{paddingLeft: '10px'}}>3. Third-Party Services and Content</a><br/>
            <a href="#g">G. SECURITY</a><br/>
            <a href="#h">H. REGISTRATION/PASSWORDS</a><br/>
            <a href="#h1" style={{paddingLeft: '10px'}}>1. Registration.</a><br/>
            <a href="#h2" style={{paddingLeft: '10px'}}>2. Passwords.</a><br/>
            <a href="#h3" style={{paddingLeft: '10px'}}>3. Provided Information.</a><br/>
            <a href="#i">I. UNINSTALL/REMOVAL OF AN APP</a><br/>
            <a href="#j">J. CONSENT TO USE OF DATA AND USER REVIEWS</a><br/>
            <a href="#k">K. INTELLECTUAL PROPERTY</a><br/>
            <a href="#l">L. COPYRIGHT</a><br/>
            <a href="#l1" style={{paddingLeft: '10px'}}>1. Copyright/Submissions.</a><br/>
            <a href="#m">M. TERMINATION</a><br/>
            <a href="#n">N. DISCLAIMER OF WARRANTY</a><br/>
            <a href="#o">O. LIMITATION OF LIABILITY</a><br/>
            <a href="#p">P. INDEMNIFICATION</a><br/>
            <a href="#q">Q. EXPORT CONTROLS</a><br/>
            <a href="#r">R. NOTICE TO US GOVERNMENT END USERS</a><br/>
            <a href="#s">S. JURISDICTIONAL AVAILABILITY</a><br/>
            <a href="#t">T. DISPUTE RESOLUTION AND OTHER MISCELLANEOUS TERMS</a><br/>
            <a href="#u">U. HOW TO CONTACT US.</a><br/>
            <a href="#v">V. SUPPLEMENTAL TERMS</a><br/>
            <a href="#v1" style={{paddingLeft: '10px'}}>1. Weather Content and Attribution.</a><br/>
            <a href="#v2" style={{paddingLeft: '10px'}}>2. Third Party Content or Images.</a><br/>
            <a href="#v3" style={{paddingLeft: '10px'}}>3. Youtube.</a><br/>
            <a href="#v4" style={{paddingLeft: '10px'}}>4. Apple App Store.</a><br/>
            <a href="#v5" style={{paddingLeft: '10px'}}>5. Windows Phone Store</a>
          </div>
          <h4><a name="a"></a>A. AGREEMENT:</h4>
          <p>These Terms are a legal agreement between you and Clime. By using the Services, including installing and/or
            downloading any of our mobile applications (each an "App" and collectively the "Apps"), you: (a) agree to be
            bound by these Terms, (b) you represent and warrant that you have the right, authority and capacity to enter
            into these Terms just as if you had signed it; and (c) if you are accessing the Services through one of our
            ...
            agreement with us. <strong>If you do not agree to these Terms, do not install or use any App or
              Services.</strong> We may amend these Terms from time to time and will notify you of any update to the
            ...
            amendments to these Terms will signify your acceptance of such amendments. <strong>If you do not agree with
              any amendment, you must discontinue using the Services (including any Apps).</strong> If you have any
            questions or concerns regarding these Terms, please contact support at the email provided in Section U
            below. Do not use the Services until your questions and concerns have been answered to your satisfaction and
            you agree to abide by these Terms.</p>
          <p><strong>Notice to consumers</strong>: Depending on the laws of the jurisdiction where you live, you may
            ...
            the remainder of these Terms shall remain in full force and effect.</p>
          <p>Use of the Services is subject to our <a href="{{ url('homepagePrivacyPolicy') }}">Privacy Policy</a>,
            which is hereby incorporated into these Terms by reference. These Terms also include any additional payment
            ...
            that may have additional terms, conditions and usage rules that govern your use of the Apps if you download
            or install the Apps through such marketplaces.</p>
          <h4><a name="b"></a>B. AGE REQUIREMENT</h4>
          <p><strong>You must be 13 years of age (or 16 in the EEA) or older to install or to use the Apps.</strong></p>
          <h4><a name="c"></a>C. GRANT OF LICENSE</h4>
          <p>Subject to your compliance with these Terms, Clime grants you a limited, non-exclusive, revocable,
            non-sublicensable, non-transferable license, to access, download and/or install the most current generally
            available version of the software provided to you as part of the Services solely for your lawful, personal,
            and non-commercial use.</p>
          <h4><a name="d"></a>D. DESCRIPTION OF OTHER RIGHTS AND LIMITATIONS</h4>
          <p><strong><a name="d1"></a>1. Restricted Use.</strong> You may not rent, sell, lease, sublicense, distribute,
            ...
            used by multiple users. You agree that you will not use any robot, spider, other automatic or manual device
            ...
            security of our Services. You may not modify, reverse-engineer, decompile, disassemble, or otherwise tamper
            with any Services, or attempt to do so for any reason or by any means. You may not access, create or modify
            the source code of any Services in any way. You do not have the right to and may not create derivative works
            of any Services or any portions thereof. All modifications or enhancements to the Services remain the sole
            property of Clime.</p>
          <p><strong><a name="d2"></a>2. Updates</strong> We reserve the right to add or remove features or functions to
            existing Services. When installed on your mobile device, the Apps periodically communicate with our servers.
            We may require the updating of the Apps on your mobile device when we release a new version of the Apps, or
            ...
            Services may be ended upon the availability of updates, supplements or subsequent versions. You acknowledge
            and agree that we have no obligation to make available to you any updates, supplements or updated versions
            of the Services.</p>
          <p><strong><a name="d3"></a>3. Access</strong> You must provide at your own expense the equipment, Internet
            ...
            your network provider or device. Clime makes no representation that the Apps can be accessed on all devices
            or wireless service plans. Clime makes no representation that the Apps are available in all languages or
            that the Apps are appropriate or available for use in any particular location.</p>
          <strong><a name="d4"></a>4. Purchases &amp; Cancellation Rights.</strong><br/><br/>
            <p><a name="da"></a>(A). Subscriptions.</p>
            <p>You may purchase certain Services on a subscription basis. Some Services may offer different subscription
              ...
              or directly through Clime and its third party payment processor.</p>
            <p>You may be offered a free trial of a subscription to our Services for a limited period of time. You are
              ...
              manage your subscriptions. <strong>Please note: your free-trial subscription will automatically renew as a
                ...
                trial period.</strong></p>
            <p>If you subscribed for our Services by purchasing and installing an App through a third party mobile
              ...
              settings in your iTunes or Android account.</p>
            <p>If you subscribed for our Services directly through our website, you may cancel your subscription at any
              time by logging in to manage your subscriptions on the applicable website.</p>
            <p>All cancellations will take effect starting at the end of the then current billing period. For example,
              ...
              once the charge has gone through for the billing period.</p>
            <p><a name="db"></a>(B) Paid Applications</p>
            <p>Certain Apps are available for one-time purchase (no recurring subscription) through either the Apple App
              or Google Play store. European Union residents normally have a right to cancel online purchases within 14
              days of making them. <strong>Please note and acknowledge: if you are resident in the European Union and
                ...
                purchase.</strong></p>
            <p>You may uninstall paid applications at any time at your discretion. All purchases of paid applications
              are non-refundable.</p>
            <p><strong><a name="d4"></a>5. Automatic Renewal; Recurring Charges.</strong> Paid subscriptions to the
              ...
              you in accordance with the Cancellation section of this Agreement.</p>
            <h4><a name="e"></a>E. FEATURES &amp; FUNCTIONALITY</h4>
            <p>The various features and functionalities made available through the Services may change from time to time
              and are provided by Clime and third party suppliers (the "<strong>Third Party Partners</strong>") who
            ...
            <h4><a name="f"></a>F. CONTENT ON THE SERVICES:</h4>
            <p><strong><a name="f1"></a>1. User Content.</strong> The Apps may allow users to submit and post Content
              that will be made public and available to other App users ("User Content"). You are responsible for your
              ...
              circumstances, the user is determined to be a repeat infringer.</p>
            <p>You agree that you shall not post or share User Content on the Services that Clime deems Objectionable
              Content. "Objectionable Content" includes, but it not limited to: 1. Is commercial in nature (including
              ...
              equipment and 10. is otherwise in contravention of these Terms.</p>
            <p>You represent and warrant that you own or have the necessary rights in and to the Content that you post,
              ...
              by Clime commercially at Clime's sole discretion.<br/>
              ...
              User Content through the Services.</p>
            <p><strong><a name="f2"></a>2. Content Screening and Disclosure.</strong> We do not, and cannot, pre-screen
              ...
              obligation, in our sole discretion to edit, refuse to post, or remove any Content.<br/>
              ...
              offensive behavior.</p>
            <p><strong><a name="f3"></a>3. Third-Party Services and Content.</strong> The Services may integrate, be
              ...
              monitoring any transaction between you and Third Party Partners.</p>
            <h4><a name="g"></a>G. SECURITY</h4>
            <p>The Services, like other consumer technologies, may not be 100% secure. By accepting these Terms you
              ...
              Clime shall not be liable for any unauthorized access to your account or devices.</p>
            <h4><a name="h"></a>H. REGISTRATION/PASSWORDS</h4>
            <p><strong><a name="h1"></a>1. Registration.</strong> Some Services may not require a registration: however,
              some Services will permit or require you to create an account to participate or access additional features
              or functionalities ("<strong>Registration</strong>"). If such Registration is required, it will be made
              ...
              relevant Third Party Partner's website for their policies.</p>
            <p><strong><a name="h2"></a>2. Passwords.</strong> You are the sole and exclusive guardian of any password
              ...
              incurred in connection with any misuse of any password or ID.</p>
            <p><strong><a name="h3"></a>3. Provided Information.</strong> If you provide any information in connection
              ...
              and in furtherance of your use of the App our services, in accordance with the Privacy Policy located <a
                href="{{ url('homepagePrivacyPolicy') }}">here</a>.</p>
            <h4><a name="i"></a>I. UNINSTALL/REMOVAL OF AN APP</h4>
            <p>Uninstallation and removal methods vary depending on your device. To uninstall and remove the Apps,
              ...
              payments. See our cancellation instructions above for more information.</p>
            <h4><a name="j"></a>J. CONSENT TO USE OF DATA AND USER REVIEWS</h4>
            <p>You agree that we may collect and use technical data and related information, including but not limited
              ...
              located <a href="{{ url('homepagePrivacyPolicy') }}">here</a>.</p>
            <p>Additionally, if you choose to provide app store reviews or reviews via any social medial channel, or
              ...
              not obligated to, remove any content we deem inappropriate.</p>
            <h4><a name="k"></a>K. INTELLECTUAL PROPERTY</h4>
            <p>The Services, including all Content, design, text, images, photographs, illustrations, audio-clips,
              ...
              Intellectual Property Rights. "<strong>Intellectual Property Rights</strong>" means, collectively, rights
              ...
              expressly granted hereunder are expressly reserved to Clime and its licensors.</p>
            <p>Clime and Clime names, logos and affiliated properties, are the exclusive property of Clime or its
            ...
            <h4><a name="l"></a>L. COPYRIGHT</h4>
            <p><strong><a name="l1"></a>1. Copyright/Submissions.</strong> You are solely responsible for any Content
              ...
              any Content that you contribute, submit or display.</p>
            <p>Clime respects and expects its users to respect the rights of copyright holders. On notice, Clime will
              ...
              rights, Please contact Clime's Copyright Agent at:</p>
            <p>Clime Weather Services, LLC<br/>
              555 West 18th Street,<br/>
              New York, NY 10011<br/>
              Attn: Copyright Agent/ Legal Dept.<br/>
              Email: <a href="mailto:dmca@mosaic.co">dmca@mosaic.co</a><br/>
              For other support please see Section U below.</p>
            ...
            <ul className="list disc-type">
              ...
              <li>a statement by you that the above information in your notice is accurate and that you are the
                copyright owner or authorized to act on the copyright owner's behalf.
              </li>
            </ul>
            <br/>
            <h4><a name="m"></a>M. TERMINATION</h4>
            <p>Your rights under these Terms will terminate immediately and automatically without any notice from Clime
              ...
              these Terms for any reason.</p>
            <h4><a name="n"></a>N. DISCLAIMER OF WARRANTY</h4>
            <p>TO THE EXTENT PERMITTED BY APPLICABLE LAW, ALL SERVICES ARE PROVIDED ON AN "<strong>AS IS,</strong>"
              "WITH ALL FAULTS," AND "<strong>AS AVAILABLE</strong>" BASIS, AND YOU USE THEM AT YOUR SOLE RISK. SUBJECT
            ...
            <p>THE ENTIRE RISK ARISING OUT OF USE OR PERFORMANCE OF THE SERVICES REMAINS SOLELY WITH YOU. CLIME
              ...
              WARRANTY CONSTITUTES AN ESSENTIAL PART OF THIS AGREEMENT.</p>
            <h4><a name="o"></a>O. LIMITATION OF LIABILITY</h4>
            <p>TO THE EXTENT PERMITTED BY APPLICABLE LAWS, YOU EXPRESSLY UNDERSTAND AND AGREE THAT CLIME AND ITS
              ...
              WILL APPLY EVEN IF THE ABOVE STATED REMEDY FAILS OF ITS ESSENTIAL PURPOSE.</p>
            <p>IF ANY OF THE EXCLUSIONS SET FORTH IN THIS SECTION IS DETERMINED BY A COURT OF COMPETENT JURISDICTION TO
              ...
              SHALL APPLY AFTER SUCH PERIOD.</p>
            <h4><a name="p"></a>P. INDEMNIFICATION</h4>
            <p>YOU AGREE TO INDEMNIFY, DEFEND AND HOLD HARMLESS CLIME, ITS PARENTS, AFFILIATE AND SUBSIDIARY COMPANIES,
              ...
              NOTIFY CLIME OF ANY UNAUTHORIZED USE OF YOUR ACCOUNT OR ANY OTHER BREACH OF SECURITY KNOWN TO YOU.</p>
            <h4><a name="q"></a>Q. EXPORT CONTROLS</h4>
            <p>The Services and the underlying information and technology are subject to US and international laws,
              restrictions and regulations that may govern the import, export, downloading and use of the Apps. You
              agree to comply with these laws, restrictions and regulations when downloading or using the apps.</p>
            <h4><a name="r"></a>R. NOTICE TO US GOVERNMENT END USERS</h4>
            <p>Any Services used or Apps installed for or on behalf of the United States of America, its agencies and/or
              instrumentalities ("U.S. Government"), is provided with Restricted Rights as "commercial Items," as that
              terms is defined at 48 C.F.R. &sect;2.101, consisting of "Commercial Computer Software" and "Commercial
              ...
              52.227-19, as applicable.</p>
            <h4><a name="s"></a>S. JURISDICTIONAL AVAILABILITY</h4>
            <p>Clime does not represent or warrant that the Services or any part thereof is appropriate or available for
              use in any particular jurisdiction. We may limit the availability of the Apps, in whole or in part, to any
              person, geographic area or jurisdiction we choose, at any time and in our sole discretion.</p>
            <h4><a name="t"></a>T. DISPUTE RESOLUTION AND OTHER MISCELLANEOUS TERMS</h4>
            <p>Except for members residing within the European Economic Area and elsewhere where prohibited by
              applicable law:</p>
            <p>The exclusive means of resolving any dispute or claim arising out of or relating to these Terms
            ...
            <p>The one exception to the exclusivity of arbitration is that either party has the right to bring an
              ...
              Company any class action, class arbitration, or other representative action or proceeding.</p>
            <p>By using the Services in any manner, you agree to the above arbitration agreement. In doing so, YOU GIVE
            ...
            <p>Governing Law. The laws of New York, without regard to conflict of laws principles, shall govern all
              matters relating to or arising from these Terms, and the use (or inability to use) the Services.</p>
            <p>The online dispute settlement platform of the European Commission is available under
              http://ec.europa.eu/odr. Clime does not take part in dispute settlement procedures in front of a consumer
              arbitration entity for members residing in the EU or European Economic Area.</p>
            <p>No failure or delay by Clime in exercising any right, power or privilege under these Terms will operate
            ...
            <p>YOU AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE SERVICES MUST COMMENCE WITHIN THREE
              (3) YEARS AFTER THE CAUSE OF ACTION ACCRUES. OTHERWISE, SUCH CAUSE OF ACTION IS PERMANENTLY BARRED.</p>
            <h4><a name="u"></a>U. HOW TO CONTACT US.</h4>
            <p>If you have any questions about these Terms, please contact us by email or postal mail as follows:</p>
            <p>Clime Weather Services, LLC<br/>
              555 West 18th Street,<br/>
              New York, NY 10011<br/>
              ATTN: Legal Dept.<br/>
              For Clime: <a href="mailto:support@climeradar.com">support@climeradar.com</a><br/>
              For Planes Live: <a href="mailto:support@planeslive.app">support@planeslive.app</a>
            </p>
            <h4><a name="v"></a>V. SUPPLEMENTAL TERMS</h4>
            <p>To the extent permitted by applicable law (and without limiting the above rights, remedies and
              obligations except the extent expressly in conflict with additional terms below), the following additional
              terms shall apply to your use of the Services, as applicable:</p>
            <p><strong><a name="v1"></a>1. Weather Content and Attribution.</strong> We may use content from third party
              weather sources.</p>
            <p><strong>1.</strong> We use data products or imagery from the Land, Atmosphere Near real-time Capability
              for EOS (LANCE) system (including the use of data and imagery from LANCE FIRMS) operated by NASA's Earth
              Science Data and Information System (ESDIS), with funding provided by NASA Headquarters.</p>
            <p><strong>2.</strong> Certain watches, warnings, advisories, and other similar products with meteorological
              ...
              government source.</p>
            <p><strong>3.</strong> Wildfire data provided by The National Interagency Fire Center’s Wildfire Open Data
              Project (https://data-nifc.opendata.arcgis.com/) and is for information purposes only.</p>
            <p><strong>4.</strong> Air quality and certain weather event data provided by AerisWeather.</p>
            <p><strong>5.</strong> Rain radar and other weather radar data provided by Foreca.</p>
            <p><strong>6.</strong> Nearest hour precipitation data is powered by Tomorrow.io.</p>
            <p><strong>7.</strong> Location Search powered by OpenStreetMap contributors.</p>
            <p><strong><a name="v2"></a>2. Third Party Content or Images.</strong> Certain Services include content,
              footage and/or images (collectively "Images") licensed to Clime by third parties such as Getty Images
              (US), Inc. By utilizing these Services, you specifically acknowledge and agree that:</p>
            <p><strong>1.</strong> You may only use the Images as enabled by Services, for display in digital form.</p>
            <p><strong>2.</strong> You may not sell or re-sell Images, and may not modify or re-use Images, except as
              enabled through features or technology available in the Services.</p>
            ...
            <p><strong>4.</strong> If you use Images featuring an individual(s) in connection with a sensitive,
              unflattering or controversial subject, you must include a statement that the image is used for
              illustrative purposes only and the individual is a model.</p>
            <p><strong>5.</strong> You may not remove any metadata in Images, or reverse engineer, decompile, or
              disassemble the Services or any technology available through the Services to enable the download or use of
              Images on a stand-alone basis.</p>
            <p><strong>6.</strong> No ownership or copyrights to any Images are granted to you.</p>
            <p><strong><a name="v3"></a>3. Youtube.</strong> Certain Services may incorporate or provide you with access
              to Youtube content. By using such Services, you agree that you will comply with Youtube's Terms of Service
              available <a href="https://www.youtube.com/t/terms" target="_blank">here</a>.</p>
            <p><strong><a name="v4"></a>4. Apple App Store. </strong> By accessing the Services through a device made by
              Apple, Inc. ("Apple"), you specifically acknowledge and agree that:</p>
            <p><strong>1.</strong> These Terms are between Clime and you; Apple is not a party to these Terms.</p>
            <p><strong>2.</strong> The license granted to you hereunder is limited to a personal, limited,
            ...
            <p><strong>3.</strong> Apple is not responsible for our Apps or the content therein and has no obligation
              whatsoever to furnish any maintenance or support services with respect to any of our Apps.</p>
            <p><strong>4.</strong> In the event of any failure of an App to conform to any applicable warranty, you may
              ...
              App.</p>
            <p><strong>5.</strong> Apple is not responsible for addressing any claims by you or a third party relating
              ...
              regulatory requirement; and (c) claims arising under consumer protection or similar legislation.</p>
            <p><strong>6.</strong> In the event of any third party claim that an App or your possession and use of the
              App infringes such third party's intellectual property rights, Apple is not responsible for the
              investigation, defense, settlement or discharge of such intellectual property infringement claim.</p>
            <p><strong>7.</strong> You represent and warrant that (a) you are not located in a country that is subject
              ...
              parties.</p>
            <p><strong>8.</strong> Apple and its subsidiaries are third party beneficiaries of these Terms and upon your
              acceptance of the terms and conditions of these Terms, Apple will have the right (and will be deemed to
              have accepted the right) to enforce these Terms against you as a third party beneficiary hereof.</p>
            <p><strong>9.</strong> Clime expressly authorizes use of the Apps by multiple users through the Family
              Sharing or any similar functionality provided by Apple.</p>
            <p><strong><a name="v5"></a>5. Windows Phone Store: </strong> By downloading on of ourApps from the Windows
              Phone Store, you specifically acknowledge and agree that:</p>
            <p><strong>1.</strong> You may install and use one copy of the App on up to five (5) Windows Phone enabled
              devices that are affiliated with the Microsoft account you use to access the Windows Phone Store. Beyond
              that, we reserve the right to apply additional conditions or charge additional fees.</p>
            <p><strong>2.</strong> You acknowledge that Microsoft Corporation, your phone manufacturer and network
