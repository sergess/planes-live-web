  ...
  return (
    <ModalProvider>
      ...
      <main className={styles.main}>
        <p>Read the Privacy Policy <Link href="privacyPolicy">here</Link>.</p>
        ...
        <div className={styles.text}>
          ...
          <p>Use of the Services is subject to our <Link href="privacyPolicy">Privacy Policy</Link>,
          ...
          <strong><a name="d4"></a>4. Purchases &amp; Cancellation Rights.</strong><br/><br/>
            ...
            <p><strong><a name="h3"></a>3. Provided Information.</strong> If you provide any information in connection
              ...
              and in furtherance of your use of the App our services, in accordance with the Privacy Policy located <Link href="privacyPolicy">here</Link>.</p>
            ...
            <p>You agree that we may collect and use technical data and related information, including but not limited
              ...
              located <Link href="privacyPolicy">here</Link>.</p>
